...
@NamedQueries({
	@NamedQuery(name = "CLIENTI.findClienteByCodCliente", query = "SELECT c FROM Clienti c WHERE c.codCliente = :cod_cliente"),
	@NamedQuery(name = "CLIENTI.findClienteByIdCliente", query = "SELECT c FROM Clienti c WHERE c.id = :id_cliente"),
	@NamedQuery(name = "CLIENTI.count", query = "SELECT COUNT(c) FROM Clienti c"),
	@NamedQuery(name = "CLIENTI.maxId", query = "SELECT MAX(c.id) FROM Clienti c")
})
